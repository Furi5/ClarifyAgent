...
MAX_AGENT_TURNS = int(os.getenv("MAX_AGENT_TURNS", "4"))  # 每个子代理最大搜索轮次，默认4
SOFT_EXIT_TIMEOUT = float(os.getenv("SOFT_EXIT_TIMEOUT", "90.0"))  # Runner.run 软退出时间(秒)，默认90秒（比硬超时180s短，但给足够时间）
